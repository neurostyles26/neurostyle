  ...
  <div class="relative min-h-screen flex items-center justify-center bg-[#020202] p-6 font-inter overflow-hidden">
    ...
    <div class="w-full max-w-md z-10 px-4">
      <div class="text-center mb-10">
        <router-link to="/" class="inline-block mb-8 group">
          <div class="relative w-24 h-24 md:w-28 md:h-28 mx-auto transition-transform duration-500 group-hover:scale-110">
        ...
        <h1 class="text-white text-3xl md:text-4xl font-outfit font-bold tracking-tight mb-2">Acceso <span class="text-primary italic">Elite</span></h1>
        <p class="text-gray-500 text-[10px] uppercase tracking-[0.3em] font-black">Consola de Gestión Administrativa</p>
      </div>

      <div class="glass-panel p-6 md:p-10 rounded-[32px] md:rounded-[40px] border-white/10 shadow-2xl relative overflow-hidden group">
        <!-- Inner glow -->
        ...
        <form @submit.prevent="handleLogin" class="space-y-6 md:space-y-8 relative z-10">
          <div>
            <label class="block text-primary text-[10px] font-black uppercase tracking-[0.3em] mb-3 md:mb-4 ml-2">Identificación de Usuario</label>
            <div class="relative group/input">
              ...
              <input 
                ...
                type="email" 
                required
                class="w-full bg-white/[0.03] border border-white/10 rounded-2xl py-4 md:py-5 pl-12 pr-6 text-white focus:outline-none focus:border-primary/50 transition-all placeholder:text-gray-700 font-medium text-sm md:text-base"
          ...
          <div>
            <label class="block text-primary text-[10px] font-black uppercase tracking-[0.3em] mb-3 md:mb-4 ml-2">Clave de Acceso Segura</label>
            <div class="relative group/input">
          ...
          <button 
            type="submit" 
            :disabled="loading"
            class="w-full bg-primary text-black font-black py-4 md:py-6 rounded-2xl md:rounded-3xl flex items-center justify-center text-base md:text-lg hover:scale-[1.02] active:scale-95 disabled:opacity-50 transition-all shadow-[0_15px_30px_rgba(218,165,32,0.2)] group overflow-hidden"
          >
            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
            <span v-if="loading" class="animate-pulse">VERIFICANDO...</span>
            <span v-else class="font-outfit uppercase tracking-widest text-sm md:text-base">INGRESAR AL SISTEMA</span>

<template>
  ...
  >
    <div v-if="show" class="fixed inset-0 z-[999] bg-[#020202] flex flex-col items-center justify-center overflow-hidden">
      ...
      <!-- Bottom Branding -->
      <div class="absolute bottom-12 text-[8px] font-medium text-white/40 tracking-[0.6em] uppercase animate-fade-in-slow flex flex-col items-center gap-4">
          <div>EST. 2024 <span class="mx-1 text-primary/20">|</span> MASTER BARBERING <span class="mx-1 text-primary/20">|</span> NEURAL TECH</div>
          <div class="text-primary/60 tracking-[1em] ml-[1em]">BY EDISSOF</div>
      </div>
    </div>
  </transition>
</template>
